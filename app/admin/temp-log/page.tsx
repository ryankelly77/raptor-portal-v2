...
import styles from './temp-log.module.css';
...
export default function AdminTempLogPage() {
  const router = useRouter();
  const { isAuthenticated, isLoading: authLoading, adminInfo } = useAdminAuth();
  ...
  useEffect(() => {
    ...
    init();
  }, [authLoading, isAuthenticated, loadSession, loadProperties, router]);
  ...
  // Loading state
  if (authLoading || (loading && !session && !completedSession)) {
    return (
    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerTitle}>
          <Image src="/logo-dark.png" alt="Raptor Vending" width={32} height={32} />
        ...
        {completedSession ? (
          ...
          <div className={styles.completed}>
            <div className={styles.branding}>
              <Image src="/logo-dark.png" alt="Raptor Vending" width={120} height={48} />
            ...
            <p className={styles.completedMessage}>Your temperature log has been saved.</p>
            <button onClick={() => setCompletedSession(null)} className={styles.btnPrimary}>
              Start New Session
            </button>
          ...
          <div className={styles.noSession}>
            ...
            <p>Begin logging temperatures for your delivery run.</p>
            ...
            <button onClick={handleStartSession} className={styles.btnPrimary} disabled={loading}>
              {loading ? 'Starting...' : 'Start Temperature Session'}
            </button>
          </div>
        ) : (
          // Active session
          <div className={styles.session}>
            ...
            <div className={styles.entries}>
              {(!session.entries || session.entries.length === 0) ? (
                ...
                session.entries.map((entry) => {
                  ...
                  return (
                    <div key={entry.id} className={`${styles.entryCard} ${isPickup ? styles.entryPickup : styles.entryDelivery}`}>
            ...
            {showAddEntry ? (
              <form onSubmit={handleAddEntry} className={styles.entryForm}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <div className={styles.tempControl}>
                    <button type="button" className={styles.tempMinus} onClick={() => adjustTemp(-1)}>-</button>
                    <input
                      type="number"
                      value={temperature}
                    ...
                    />
                    <button type="button" className={styles.tempPlus} onClick={() => adjustTemp(1)}>+</button>
                  </div>
                  {temperature > 41 && (
                ...
                <div className={styles.formActions}>
                  <button type="button" onClick={() => setShowAddEntry(false)} className={styles.btnCancel}>
                    Cancel
                  </button>
              ...
              <div className={styles.actions}>
                ...
                <button onClick={handleCompleteSession} className={styles.btnSecondary}>
                  Complete Session
                </button>
              </div>
            )}
